...
public class MainActivity extends Activity implements VASTPlayer.Listener, VASTParser.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player = (VASTPlayer) findViewById(R.id.pubnative_vast_player);
    ...
    public void onLoadClick(View view) {
        ...
        new VASTParser(this).setListener(this).execute(VAST);
